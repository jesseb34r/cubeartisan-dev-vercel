...
export const ListHero = () => (
  <div class={styles.hero}>
    <header class={styles.heroHeader}>
      <h1 class={styles.heroTitle}>Mortal Combat</h1>
      <p class={styles.heroAuthor}>by jesseb34r</p>
      <div class={styles.heroActions}>
        <Button.Root class={styles.heroActionContainer}>
          <svg
    ...
    <p class={styles.heroDescription}>
      Cube Design notes: <br />
      - "Fair stuff" gameplay <br />
      - High fixing density <br />- Draft with 2 people grid 24x9 or 4 people packs 6x9
    </p>
  </div>
);
